...
> **Using a mobile hotspot?** Enable **Compatibility Mode** (sometimes called "Maximum Compatibility" or "2.4 GHz band") in your hotspot settings — the Cardputer's WiFi radio only supports 2.4 GHz networks.
